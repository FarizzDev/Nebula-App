...
export default function Dashboard() {
  ...
  useEffect(() => {
    setMateri(getMateriList().slice(0, 3));
    setReminders(
      getReminders()
        .filter((r) => !r.done)
        .slice(0, 4),
  ...
  return (
    <div
      style={{ padding: "20px 16px", maxWidth: 600, margin: "0 auto" }}
      className="stagger"
    >
      <div style={{ marginBottom: 24 }}>
        ...
        >
          ...
          <span className="glow-text" style={{ color: "var(--color-neon-2)" }}>
            🚀
          </span>
        </h1>
      </div>
        ...
        >
          ...
          >
            ...
            <div style={{ flex: 1 }}>
              ...
              >
                Tap untuk ke Pengaturan
              </p>
            </div>
            <span style={{ color: "var(--color-text-3)", fontSize: 16 }}>
              ›
            </span>
          </div>
        </Link>
      ...
      <div
        className="glass"
        style={{ borderRadius: 14, padding: "16px", marginBottom: 12 }}
      >
        <div
          style={{
            display: "flex",
        ...
        {materi.length === 0 ? (
          <div style={{ textAlign: "center", padding: "16px 0" }}>
            ...
            <Link
              to="/materi"
              style={{ fontSize: 12, color: "var(--color-neon-2)" }}
            >
              Tambah sekarang →
            </Link>
          </div>
